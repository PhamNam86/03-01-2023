...
NewPing sonar (8, 8, 400);// create ultrasonic object with the following parameters (Trig=3, Echo=2, Max distance=400cm)
float distanceleft;// initialize a variable of type float

NewPing sonar_2 (9, 9, 400);// create ultrasonic object with the following parameters (Trig=3, Echo=2, Max distance=400cm)
float distancefront;// initialize a variable of type float

NewPing sonar_3 (10, 10, 400);// create ultrasonic object with the following parameters (Trig=3, Echo=2, Max distance=400cm)
float distanceright;// initialize a variable of type float
...
distanceleft = sonar.ping_cm();// putting the measured value in distance
Serial.print("Distance_left = ");// print "Distance"
Serial.print(distanceleft);// print the value of the distance
Serial.println(" cm");// print "cm"
delay(10);

distancefront = sonar_2.ping_cm();// putting the measured value in distance
Serial.print("Distance_front = ");// print "Distance"
Serial.print(distancefront);// print the value of the distance
Serial.println(" cm");// print "cm"
delay(10);

distanceright = sonar_3.ping_cm();// putting the measured value in distance
Serial.print("Distance_right = ");// print "Distance"
Serial.print(distanceright);// print the value of the distance
Serial.println(" cm");// print "cm"
delay(10);
  ...
  if((s==LOW)&&(distanceleft <= 30 && distancefront <= 30 && distanceright <= 30) || (s==LOW)&&(distanceleft < 30 && distancefront < 30 && distanceright < 30))
    {
      goLeft();
      delay(1500);
    }
  ...
  if ((s==LOW)&&(distanceleft <= 30 && distancefront <= 30 && distanceright > 30)||(s==LOW)&&(distanceleft <= 30 && distancefront <= 30 && distanceright > 30)||(s==LOW)&& (distanceleft <= 30 && distancefront > 30 && distanceright > 30)||(distanceleft <= 30 && distancefront > 30 && distanceright > 30))
  {//goRight
    goRight();
    
    
  }
  if ((s==LOW)&&(distanceleft > 30 && distancefront <= 30 && distanceright <= 30) ||(s==LOW)&& (distanceleft > 30 && distancefront > 30 && distanceright <= 30) ||(s==LOW)&& (distanceleft > 30 && distancefront <= 30 && distanceright > 30) )
  {//goLeft
    goLeft();
  }  
